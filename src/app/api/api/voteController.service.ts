...
export class VoteControllerService extends BaseService {
    ...
    /**
     * Batch of Multiple votes inserted
     * Multiple insert
     * @param sectionId 
     * @param voteRequest 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
    public insertBatchMultipleVote(sectionId: number, voteRequest: Array<VoteRequest>, observe?: 'body', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | '*/*', context?: HttpContext, transferCache?: boolean}): Observable<VoteResponse>;
    public insertBatchMultipleVote(sectionId: number, voteRequest: Array<VoteRequest>, observe?: 'response', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | '*/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpResponse<VoteResponse>>;
    public insertBatchMultipleVote(sectionId: number, voteRequest: Array<VoteRequest>, observe?: 'events', reportProgress?: boolean, options?: {httpHeaderAccept?: 'application/json' | '*/*', context?: HttpContext, transferCache?: boolean}): Observable<HttpEvent<VoteResponse>>;
    public insertBatchMultipleVote(sectionId: number, voteRequest: Array<VoteRequest>, observe: any = 'body', reportProgress: boolean = false, options?: {httpHeaderAccept?: 'application/json' | '*/*', context?: HttpContext, transferCache?: boolean}): Observable<any> {
        if (sectionId === null || sectionId === undefined) {
            throw new Error('Required parameter sectionId was null or undefined when calling insertBatchMultipleVote.');
        }
        if (voteRequest === null || voteRequest === undefined) {
            throw new Error('Required parameter voteRequest was null or undefined when calling insertBatchMultipleVote.');
        }
        ...
        let localVarPath = `/votes/multiple/batch/${this.configuration.encodeParam({name: "sectionId", value: sectionId, in: "path", style: "simple", explode: false, dataType: "number", dataFormat: "int64"})}`;
        const { basePath, withCredentials } = this.configuration;
