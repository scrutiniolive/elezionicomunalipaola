...
export * from './turnoutController.service';
import { TurnoutControllerService } from './turnoutController.service';
export * from './voteController.service';
import { VoteControllerService } from './voteController.service';
export const APIS = [AuthenticationControllerService, CardControllerService, DashboardControllerService, ElectionDisplayControllerService, SectionControllerService, TurnoutControllerService, VoteControllerService];
